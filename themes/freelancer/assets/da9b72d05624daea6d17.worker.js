...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_get_object_value__ = __webpack_require__(8);
...
onmessage = function onmessage(e) {
    var data = __WEBPACK_IMPORTED_MODULE_0_get_object_value___default()(e, ['data']);
    switch (data.type) {
        case 'initWs':
            initWs(data.ws);
            break;
...
var ajaxGet = function ajaxGet(_ref) {
    ...
    new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 0)).then(function (req) {
