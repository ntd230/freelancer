...
var _getObjectValue = __webpack_require__(89);
...
var ajaxGet = function ajaxGet(_ref) {
    ...
    __webpack_require__.e/* require */(16).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(551)]; (function (req) {
...
var ajaxPost = function ajaxPost(_ref2) {
    ...
    var params = (0, _getObjectValue2.default)(action, ['params'], {});
    __webpack_require__.e/* require */(16/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(551)]; (function (req) {
